...
def Online_variant(repo,scen):
    ...
    architecture_1=ActivePDB_Evaluation(learnerModule,BooleanEvaluationModule_Online,ProbeSelectorModule)



    idx,truth_value=architecture_1.Evaluate_activePDB(repo,scen)
    print(idx)
    print(truth_value)
...
def variant_LC_plus_CtU(repo,scen):
    ...
    architecture_1 = ActivePDB_Evaluation(learnerModule, BooleanEvaluationModule_Q_Value, ProbeSelectorModule)
    idx, truth_value = architecture_1.Evaluate_activePDB(repo, scen)
    print(idx)
    print(truth_value)
...
def Greedy_Variant(repo, scen):
    ...
    ProbeSelectorModule = UtilityOnly()
    architecture_1 = ActivePDB_Evaluation(learnerModule, BooleanEvaluationModule_Greedy, ProbeSelectorModule)
    idx, truth_value = architecture_1.Evaluate_activePDB(repo, scen)
    print(idx)
    print(truth_value)
